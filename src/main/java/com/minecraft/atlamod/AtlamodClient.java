...
public class AtlamodClient {
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        // Some com.minecraft.atlamod.client setup code
        Atlamod.LOGGER.info("HELLO FROM CLIENT SETUP");
        Atlamod.LOGGER.info("MINECRAFT NAME >> {}", Minecraft.getInstance().getUser().getName());
    }
}