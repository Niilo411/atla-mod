...
public class Atlamod {
    ...
    public Atlamod(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Everything the player is allowed to change. SERVER, so it belongs to a world
        // rather than to an installation and reaches every client — see AtlaConfig.
        modContainer.registerConfig(ModConfig.Type.SERVER, AtlaConfig.SPEC);
    }
